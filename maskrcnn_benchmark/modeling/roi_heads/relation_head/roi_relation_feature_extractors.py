...
class RelationFeatureExtractor(nn.Module):
    ...
    """
    def __init__(self, cfg, in_channels, roi_align):
        ...
        if cfg.MODEL.ATTRIBUTE_ON:
            ...
            self.feature_extractor = make_roi_box_feature_extractor(cfg, in_channels, roi_align=False, cat_all_levels=pool_all_levels)
...
def make_roi_relation_feature_extractor(cfg, in_channels, roi_align):
    func = registry.ROI_RELATION_FEATURE_EXTRACTORS[
        cfg.MODEL.ROI_RELATION_HEAD.FEATURE_EXTRACTOR
    ]
    return func(cfg, in_channels, roi_align)
